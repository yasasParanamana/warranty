package com.oxcentra.warranty.controller.warrenty.sparepart;
...
@Controller
@Scope("request")
public class SparePartController implements RequestBeanValidation<Object> {
    ...
    @GetMapping(value = "/viewSparePart")
    ...
    public ModelAndView getSytemUserPage(ModelMap modelMap, Locale locale) {
        ...
        try {
            ...
            modelAndView = new ModelAndView("sparepartview", "beanmap", new ModelMap());
        } catch (Exception e) {
            logger.error("Exception  :  ", e);
            //set the error message to model map
            modelMap.put("msg", messageSource.getMessage(MessageVarList.COMMON_ERROR_PROCESS, null, locale));
            modelAndView = new ModelAndView("sparepartview", modelMap);
        }
        return modelAndView;
    }

    @PostMapping(value = "/listSparePart", headers = {"content-type=application/json"})
    @AccessControl(pageCode = PageVarList.SECTION_MGT_PAGE, taskCode = TaskVarList.VIEW_TASK)
    public @ResponseBody
    ...
    @PostMapping(value = "/listDualSparePart", headers = {"content-type=application/json"})
    @AccessControl(pageCode = PageVarList.SECTION_MGT_PAGE, taskCode = TaskVarList.VIEW_TASK)
    public @ResponseBody
    ...
    @PostMapping(value = "/addSparePart", produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @PostMapping(value = "/updateSparePart", produces = {MediaType.APPLICATION_JSON_VALUE})
    @AccessControl(pageCode = PageVarList.SECTION_MGT_PAGE, taskCode = TaskVarList.UPDATE_TASK)
    public @ResponseBody
    ...
    @PostMapping(value = "/deleteSparePart", produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @PostMapping(value = "/confirmSparePart", produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @PostMapping(value = "/rejectSparePart", produces = {MediaType.APPLICATION_JSON_VALUE})
