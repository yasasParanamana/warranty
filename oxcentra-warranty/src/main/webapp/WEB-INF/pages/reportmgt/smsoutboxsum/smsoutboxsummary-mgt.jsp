    ...
    <script type="text/javascript">
        ...
        function loadDataTable() {
            ...
            oTable = $('#table').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listSmsOutBoxSum.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listSmsOutBoxSum.json",
                ...
                columnDefs: [
                    {
                        title: "Sent to Telco Count",
                        targets: 0,
                        mDataProp: "telcoCount",
                        defaultContent: "--"
                    },
                    {
        ...
        function viewPDFReport() {
            form = document.getElementById('smsoutboxsumreportview');
            form.action = 'downloadPdfReportSmsOutBoxSum.htm';
            form.submit();
        }

        function viewExcelReport() {
            form = document.getElementById('smsoutboxsumreportview');
            form.action = 'downloadExcelReportSmsOutBoxSum.htm';
            form.submit();
        }

        function viewCsvReport() {
            form = document.getElementById('smsoutboxsumreportview');
            form.action = 'downloadCsvReportSmsOutBoxSum.htm';
            form.submit();
        }
    </script>
</head>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Sms Outbox Summary Report</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <h3 class="card-title">Search Sms Outbox Summary</h3>
                        </div>

                        <!--begin::Form-->
                        <form:form class="form" id="smsoutboxsumreportview" name="smsoutboxsumreportview" action="SmsOutBox"
                                   theme="simple" method="post" modelAttribute="smsoutboxsumreport">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select id="telco" name="telco" class="form-control form-control-sm">
                                            ...
                                            <c:forEach items="${smsoutboxsumreport.telcoList}" var="telco">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select id="smschannel" name="channel" class="form-control form-control-sm">
                                            ...
                                            <c:forEach items="${smsoutboxsumreport.smsChannelList}" var="smschannel">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select path="category" name="category" id="category"
                                            ...
                                            <c:forEach items="${smsoutboxsumreport.categoryList}" var="categoryList">
                                    ...
                                    <div class="col-lg-4">
                                        <label>Status:</label>
                                        <select path="status" name="status" id="status"
                                                class="form-control form-control-sm">
                                            <option selected value="">Select Status</option>
                                            <c:forEach items="${smsoutboxsumreport.statusList}" var="statusList">
                                                <option value="${statusList.statusCode}">${statusList.description}</option>
                                            </c:forEach>
                                        </select>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select path="txntype" name="txnType" id="txntype"
                                            ...
                                            <c:forEach items="${smsoutboxsumreport.txnTypeList}" var="txnList">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <c:if test="${smsoutboxsumreport.vdownload}">
                ...
                <div class="card-body">
                    ...
                    <div id="data-table-wrapper" style="display: none;">
                        <table class="table table-separate table-head-custom table-checkable" id="table">
                            <thead>
                            <tr>
                                <th>Sent to Telco Count</th>
                                <th>Delivered Count</th>
                                <th>Expired Count</th>
                                <th>Rejected Count</th>
                                <th>Total No. of SMSs</th>
                            </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
