    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="d-flex flex-column">
                <a href="#"
                   class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">${sessionBean.user.fullname}</a>
                <div class="text-muted mt-1">${sessionBean.user.mobile}</div>
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
                            ...
                            <span class="navi-text text-muted text-hover-primary">${sessionBean.user.email}</span>
                            </span>
                    </a>
                    <a href="${pageContext.request.contextPath}/logout.htm?error=0" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" id="sign_out_home">Sign Out</a>
                    <a href="${pageContext.request.contextPath}/viewPasswordChange.htm" class="btn btn-sm btn-light-danger font-weight-bolder py-2 px-5">Change Password</a>
                </div>
            </div>
        </div>
        <!--end::Header-->
