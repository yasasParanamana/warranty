...
<div class="modal fade" id="modalAddUserParam" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Insert User Params</h6>
            ...
            <form:form class="form-horizontal sm" id="addUserParamForm" modelAttribute="userParam" method="post"
                       name="addUserParamForm">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="code" class="col-sm-4 col-form-label">Code<span
                                class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <form:input path="paramCode" name="code" type="text" class="form-control form-control-sm"
                                        id="aCode" maxlength="8" placeholder="Code"
                    ...
                    <div class="form-group row">
                        <label for="status" class="col-sm-4 col-form-label">Category<span
                                class="text-danger">*</span></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <form:select path="status" name="status" class="form-control form-control-sm" id="aStatus"
                                         readonly="true">
                                <c:forEach items="${userParam.statusActList}" var="status">
...
<script>
    ...
    function add() {
        resetAddUserParamForm();
        $.ajax({
            type: 'POST',
            url: '${pageContext.request.contextPath}/addUserParam.json',
            data: $('form[name=addUserParamForm]').serialize(),
    ...
    function resetAddUserParamForm() {
