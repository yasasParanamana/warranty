...
<link rel="stylesheet" type="text/css"
      href="${pageContext.request.contextPath}/resources/css/smppconfig/smppconfig.css?${initParam['version']}"/>
<html>
<head>
    <script type="text/javascript">
        ...
        function loadDataTable() {
            ...
            oTable = $('#table').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listSmppConfiguration.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    aoData.push(
                        {'name': 'csrf_token', 'value': token},
                        {'name': 'header', 'value': header},
                        {'name': 'smppCode', 'value': $('#smppCode').val()},
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listSmppConfiguration.json",
                ...
                columnDefs: [
                    ...
                    {
                        visible: ${smppconfig.vupdate},
                        title: "Update",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="editBtn" class="btn btn-default btn-sm"  onclick="editSmppConfiguration(\'' + full.smppCode + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-edit.svg" alt=""></button>';
                        },
                        targets: 17,
                        defaultContent: "--"
                    },
                    {
                        visible: ${smppconfig.vdelete},
                        title: "Delete",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="deleteBtn" class="btn btn-default btn-sm"  onclick="deleteSmppConfiguration(\'' + full.smppCode + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-delete.svg" alt=""></button>';
                        },
                        targets: 18,
                        defaultContent: "--"
                    }
        ...
        function loadDataTableDual() {
            ...
            oTableDual = $('#tabledual').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listDualSmppConfiguration.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    aoData.push(
                        {'name': 'csrf_token', 'value': token},
                        {'name': 'header', 'value': header},
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listDualSmppConfiguration.json",
                        contentType: "application/json",
                        data: stringify_aoData(aoData),
                ...
                columnDefs: [
                    ...
                    {
                        visible: ${smppconfig.vconfirm},
                        title: "Confirm",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="confirmBtn" class="btn btn-default btn-sm"  onclick="confirmSmppConfiguration(\'' + full.id + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-confirm.svg" alt=""></button>';
                        },
                        targets: 18,
                        defaultContent: "--"
                    },
                    {
                        visible: ${smppconfig.vreject},
                        title: "Reject",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="rejectBtn" class="btn btn-default btn-sm" onclick="rejectSmppConfiguration(\'' + full.id + '\');"><img src="${pageContext.request.contextPath}/resources/images/action-reject.svg" alt=""></button>';
                        },
                        targets: 19,
                        defaultContent: "--"
                    }
        ...
        function editSmppConfiguration(smppCode) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#modalUpdateSmppConfiguration').modal('toggle');
                    $('#modalUpdateSmppConfiguration').modal('show');
                },
                error: function (data) {
                    window.location = "${pageContext.request.contextPath}/logout.htm";
                }
        ...
        function openAddModal() {
            $('#modalAddSmppConfiguration').modal('toggle');
            $('#modalAddSmppConfiguration').modal('show');
        }

        function deleteCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/deleteSmppConfiguration.json',
                data: {smppCode: $('#deleteCodeCommon').val()},
                beforeSend: function (xhr) {
                    if (header && token) {
                        xhr.setRequestHeader(header, token);
                    }
        ...
        function confirmCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/confirmSmppConfiguration.json',
        ...
        function rejectCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/rejectSmppConfiguration.json',
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">SMPP Configuration Management</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <h3 class="card-title">Search SMPP Configuration</h3>
                        </div>
                        <!--begin::Form-->
                        <form:form class="form" id="smppconfigurationform" name="smppconfigurationform"
                                   action="addSmppConfiguration"
                                   theme="simple" method="post" modelAttribute="smppconfig">
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        <label>SMPP Code:</label>
                                        <div class="input-group">
                                            <input id="smppCode" name="smppCode" type="text"
                                                   onkeyup="$(this).val($(this).val().replace(/[^a-zA-Z0-9 ]/g, ''))"
                                                   maxlength="16" class="form-control form-control-sm"
                                                   placeholder="SMPP Code" autocomplete="off">
                                        </div>
                                        <span class="form-text text-muted">Please enter smpp code</span>
                                    </div>
                                    <div class="col-lg-4">
            ...
            <!--end::Card-->
            <!--begin::Card-->
            <c:if test="${smppconfig.vdualauth}">
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">SMPP configurations to be confirmed
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin: Datatable-->
...
<jsp:include page="smppconfig-mgt-add.jsp"/>
<jsp:include page="smppconfig-mgt-update.jsp"/>
