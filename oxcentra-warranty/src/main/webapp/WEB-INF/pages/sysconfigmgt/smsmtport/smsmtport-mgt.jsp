...
<link rel="stylesheet" type="text/css"
      href="${pageContext.request.contextPath}/resources/css/smsmtportmgt/smsmtportmgt.css?${initParam['version']}"/>
<html>
<head>
    <script type="text/javascript">
        ...
        function loadDataTable() {
            ...
            oTable = $('#table').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listSmsMtPort.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listSmsMtPort.json",
                ...
                columnDefs: [
                    ...
                    {
                        visible: ${smsmtport.vupdate},
                        title: "Update",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="editBtn" class="btn btn-default btn-sm" onclick="editSmsMtPort(\'' + full.mtPort + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-edit.svg" alt=""></button>';
                        },
                        targets: 6,
                        defaultContent: "--"
                    },
                    {
                        visible: ${smsmtport.vdelete},
                        title: "Delete",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="deleteBtn" class="btn btn-default btn-sm" onclick="deleteSmsMtPort(\'' + full.mtPort + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-delete.svg" alt=""></button>';
                        },
                        targets: 7,
                        defaultContent: "--"
                    }
        ...
        function loadDataTableDual() {
            ...
            oTableDual = $('#tabledual').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listDualSmsMtPort.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    aoData.push(
                        {'name': 'csrf_token', 'value': token},
                        {'name': 'header', 'value': header},
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listDualSmsMtPort.json",
                        contentType: "application/json",
                        data: stringify_aoData(aoData),
                ...
                columnDefs: [
                    ...
                    {
                        visible: ${smsmtport.vconfirm},
                        title: "Confirm",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="confirmBtn" class="btn btn-default btn-sm"  onclick="confirmSmsMtPort(\'' + full.id + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-confirm.svg" alt=""></button>';
                        },
                        targets: 7,
                        defaultContent: "--"
                    },
                    {
                        visible: ${smsmtport.vreject},
                        title: "Reject",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="rejectBtn" class="btn btn-default btn-sm" onclick="rejectSmsMtPort(\'' + full.id + '\');"><img src="${pageContext.request.contextPath}/resources/images/action-reject.svg" alt=""></button>';
                        },
                        targets: 8,
                        defaultContent: "--"
                    }
        ...
        function editSmsMtPort(mtPort) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#modalUpdateSmsMtPort').modal('toggle');
                    $('#modalUpdateSmsMtPort').modal('show');
                },
                error: function (data) {
                    window.location = "${pageContext.request.contextPath}/logout.htm";
                }
        ...
        function openAddModal() {
            $('#modalAddSmsMtPort').modal('toggle');
            $('#modalAddSmsMtPort').modal('show');
        }

        function deleteCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/deleteSmsMtPort.json',
                data: {mtPort: $('#deleteCodeCommon').val()},
                beforeSend: function (xhr) {
                    if (header && token) {
                        xhr.setRequestHeader(header, token);
                    }
        ...
        function confirmCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/confirmSmsMtPort.json',
        ...
        function rejectCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/rejectSmsMtPort.json',
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">SMS MT Port Management</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <h3 class="card-title">Search SMS MT Port</h3>
                        </div>
                        <!--begin::Form-->
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        <input id="mtPort" name="mtPort" type="text"
                                               onkeyup="$(this).val($(this).val().replace(/[^a-zA-Z0-9,_ ]/g, ''))"
                                               maxlength="10" class="form-control form-control-sm"
                                               placeholder="MT Port">
                                    </div>
                                    <span class="form-text text-muted">Please enter mt port</span>
                                </div>
                                <div class="col-lg-4">
                                    <label>Status:</label>
            ...
            <!--end::Card-->
            <!--begin::Card-->
            <c:if test="${smsmtport.vdualauth}">
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">SMS MT Ports to be confirmed
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin: Datatable-->
...
<jsp:include page="smsmtport-mgt-add.jsp"/>
<jsp:include page="smsmtport-mgt-update.jsp"/>
