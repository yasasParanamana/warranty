...
<div class="modal fade" id="modalAddSmsMtPort" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Insert SMS MT Port</h6>
            ...
            <form:form class="form-horizontal sm" id="addSmsMtPortForm" modelAttribute="smsmtport" method="post"
                       name="addSmsMtPortForm">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <form:input path="mtPort" name="mtPort" type="text" class="form-control form-control-sm"
                                        id="aMtPort" maxlength="10" placeholder="Code"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <form:select path="status" name="status" class="form-control form-control-sm" id="aStatus"
                                         readonly="true">
                                <c:forEach items="${smsmtport.statusActList}" var="status">
...
<script>
    ...
    function add() {
        resetAddSmsMtPortForm();
        $.ajax({
            type: 'POST',
            url: '${pageContext.request.contextPath}/addSmsMtPort.json',
            data: $('form[name=addSmsMtPortForm]').serialize(),
    ...
    function resetAddSmsMtPortForm() {
