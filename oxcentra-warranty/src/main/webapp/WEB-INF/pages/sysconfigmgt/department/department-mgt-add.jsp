...
<div class="modal fade" id="modalAddDepartment" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Insert Department</h6>
            ...
            <form:form class="form-horizontal sm" id="addDepartmentForm" modelAttribute="department" method="post"
                       name="addDepartmentForm">
                <div class="modal-body">
                    <div class="form-group"><span id="responseMsgAdd"></span></div>

                    <div class="form-group row">
                        <label for="code" class="col-sm-4 col-form-label">Department Code<span
                                class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <form:input path="code" name="code" type="text"
                                        class="form-control form-control-sm"
                                        id="aCode" maxlength="10" placeholder="Department Code"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <form:input path="description" name="description" type="text"
                                        class="form-control form-control-sm"
                                        id="aDescription" maxlength="100" placeholder="Description"
                                        onkeyup="$(this).val($(this).val().replace(/[^a-zA-Z0-9 ]/g, ''))"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <form:select path="status" name="status" class="form-control form-control-sm" id="aStatus"
                                         readonly="true">
                                <c:forEach items="${department.statusActList}" var="status">
...
<script>
    ...
    function add() {
        ...
        $.ajax({
            type: 'POST',
            url: '${pageContext.request.contextPath}/addDepartment.json',
            data: $('form[name=addDepartmentForm]').serialize(),
