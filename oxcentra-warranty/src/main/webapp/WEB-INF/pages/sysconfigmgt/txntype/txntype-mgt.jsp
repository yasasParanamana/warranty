    ...
    <script type="text/javascript">
        ...
        function loadDataTable() {
            ...
            oTable = $('#table').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listTxnType.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listTxnType.json",
                ...
                columnDefs: [
                    ...
                    {
                        visible: ${txntype.vupdate},
                        title: "Update",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="editBtn" class="btn btn-default btn-sm"  onclick="editTxnType(\'' + full.txntype + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-edit.svg" alt=""></button>';
                        },
                        targets: 7,
                        defaultContent: "--"
                    },
                    {
                        visible: ${txntype.vdelete},
                        title: "Delete",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="deleteBtn" class="btn btn-default btn-sm"  onclick="deleteTxnType(\'' + full.txntype + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-delete.svg" alt=""></button>';
                        },
                        targets: 8,
                        defaultContent: "--"
                    }
        ...
        function loadDataTableDual() {
            ...
            oTableDual = $('#tabledual').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listDualTxnType.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    aoData.push(
                        {'name': 'csrf_token', 'value': token},
                        {'name': 'header', 'value': header},
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listDualTxnType.json",
                        contentType: "application/json",
                        data: stringify_aoData(aoData),
        ...
        function editTxnType(txntype) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#modalUpdateTxnType').modal('toggle');
                    $('#modalUpdateTxnType').modal('show');
                },
                error: function (data) {
                    window.location = "${pageContext.request.contextPath}/logout.htm";
                }
        ...
        function openAddModal() {
            $('#modalAddTxnType').modal('toggle');
            $('#modalAddTxnType').modal('show');
        }

        function deleteCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/deleteTxnType.json',
                data: {txntype: $('#deleteCodeCommon').val()},
                beforeSend: function (xhr) {
                    if (header && token) {
                        xhr.setRequestHeader(header, token);
                    }
        ...
        function confirmCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/confirmTxnType.json',
        ...
        function rejectCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/rejectTxnType.json',
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">TxnType Management</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <h3 class="card-title">Search Transaction Type</h3>
                        </div>
                        <!--begin::Form-->
                        <form:form class="form" id="txntypeform" name="txntypeform" action="addTxnType"
                                   theme="simple" method="post" modelAttribute="txntype">
                            <%--                        <form class="form">--%>
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        <label>Transaction Type Code:</label>
                                        <input id="txntype" name="txntype" type="text"
                                               onkeyup="$(this).val($(this).val().replace(/[^a-zA-Z0-9 ]/g, ''))"
                                               maxlength="20" class="form-control form-control-sm"
                                               placeholder="Transaction Type" autocomplete="off">
            ...
            <!--end::Card-->
            <!--begin::Card-->
            <c:if test="${txntype.vdualauth}">
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Transaction Types to be confirmed</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin: Datatable-->
...
<jsp:include page="txntype-mgt-add.jsp"/>
<jsp:include page="txntype-mgt-update.jsp"/>
