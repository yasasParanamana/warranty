...
<link rel="stylesheet" type="text/css"
      href="${pageContext.request.contextPath}/resources/css/category/category.css?${initParam['version']}"/>
    ...
    <script type="text/javascript">
        ...
        function loadDataTable() {
            ...
            oTable = $('#table').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listCategory.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    aoData.push(
                        ...
                        {'name': 'priority', 'value': $('#priority').val()}
                    );
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listCategory.json",
                ...
                columnDefs: [
                    ...
                    {
                        visible: ${category.vupdate},
                        title: "Update",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="editBtn" class="btn btn-default btn-sm"  onclick="editCategory(\'' + full.category + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-edit.svg" alt=""></button>';
                        },
                        targets: 12,
                        defaultContent: "--"
                    },
                    {
                        visible: ${category.vdelete},
                        title: "Delete",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="deleteBtn" class="btn btn-default btn-sm"  onclick="deleteCategory(\'' + full.category + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-delete.svg" alt=""></button>';
                        },
                        targets: 13,
                        defaultContent: "--"
                    }
        ...
        function loadDataTableDual() {
            ...
            oTableDual = $('#tabledual').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listDualCategory.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    aoData.push(
                        {'name': 'csrf_token', 'value': token},
                        {'name': 'header', 'value': header},
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listDualCategory.json",
                        contentType: "application/json",
                        data: stringify_aoData(aoData),
                ...
                columnDefs: [
                    ...
                    {
                        visible: ${category.vconfirm},
                        title: "Confirm",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="confirmBtn" class="btn btn-default btn-sm"  onclick="confirmCategory(\'' + full.id + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-confirm.svg" alt=""></button>';
                        },
                        targets: 13,
                        defaultContent: "--"
                    },
                    {
                        visible: ${category.vreject},
                        title: "Reject",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="rejectBtn" class="btn btn-default btn-sm" onclick="rejectCategory(\'' + full.id + '\');"><img src="${pageContext.request.contextPath}/resources/images/action-reject.svg" alt=""></button>';
                        },
                        targets: 14,
                        defaultContent: "--"
                    }
        ...
        function editCategory(code) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.ackwait === 'YES') {
                        $("#eackwaitYes").prop("checked", true);
                    } else {
                        $("#eackwaitNo").prop("checked", true);
                    }
        ...
        function deleteCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/deleteCategory.json',
        ...
        function confirmCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/confirmCategory.json',
        ...
        function rejectCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/rejectCategory.json',
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">SMS Category Management</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <h3 class="card-title">Search SMS Category</h3>
                        </div>
                        <!--begin::Form-->
                        <form:form class="form" id="categoryviewform" name="categorysearch" action="addCategory"
                                   theme="simple"
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select id="priority" name="priority" class="form-control form-control-sm">
                                            ...
                                            <c:forEach items="${category.priorityList}" var="priority">
                                                <option value="${priority.priorityLevel}">${priority.description}</option>
                                            </c:forEach>
                                        </select>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-1 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">SMS Category Management
                            <span class="d-block text-muted pt-2 font-size-sm">SMS Category list</span></h3>
                    </div>
                        ...
                        <div id="tablediv">
                            <table id="table" class="table table-separate table-head-custom table-checkable">
                                ...
                                <tr>
                                    ...
                                    <th>Status</th>
                                    <th>Priority</th>
                                    <th>Time to live in Queue</th>
                                    <th>Unsubscribe</th>
                                    <th>Acknowledgment Wait</th>
                                    <th>Created User</th>
                                    <th>Created Time</th>
            ...
            <!--end::Card-->
            <!--begin::Card-->
            <c:if test="${category.vdualauth}">
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Categories to be confirmed</h3>
                        </div>
                    </div>
                    <div class="card-body">
...
<jsp:include page="category-mgt-add.jsp"/>
<jsp:include page="category-mgt-update.jsp"/>
