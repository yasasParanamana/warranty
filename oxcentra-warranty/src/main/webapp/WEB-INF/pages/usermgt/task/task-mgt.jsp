    ...
    <script type="text/javascript">
        ...
        function loadDataTable() {
            ...
            oTable = $('#table').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listTask.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    aoData.push(
                        {'name': 'csrf_token', 'value': token},
                        {'name': 'header', 'value': header},
                        {'name': 'taskCode', 'value': $('#searchCode').val()},
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listTask.json",
                ...
                columnDefs: [
                    ...
                    {
                        visible: ${task.vupdate},
                        title: "Update",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="editBtn" class="btn btn-default btn-sm"  onclick="editTaskInit(\'' + full.taskCode + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-edit.svg" alt=""></button>';
                        },
                        targets: 7,
                        defaultContent: "--"
                    },
                    {
                        visible: ${task.vdelete},
                        title: "Delete",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="deleteBtn" class="btn btn-default btn-sm"  onclick="deleteTaskInit(\'' + full.taskCode + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-delete.svg" alt=""></button>';
                        },
                        targets: 8,
                        defaultContent: "--"
                    }
        ...
        function loadDataTableDual() {
            ...
            oTableDual = $('#tabledual').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listDualTask.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    aoData.push(
                        {'name': 'csrf_token', 'value': token},
                        {'name': 'header', 'value': header},
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listDualTask.json",
                        contentType: "application/json",
                        data: stringify_aoData(aoData),
        ...
        function editTaskInit(taskcode) {
            $.ajax({
        ...
        function deleteCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/deleteTask.json',
                data: {taskCode: $('#deleteCodeCommon').val()},
                beforeSend: function (xhr) {
                    if (header && token) {
                        xhr.setRequestHeader(header, token);
                    }
        ...
        function confirmCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/confirmTask.json',
        ...
        function rejectCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/rejectTask.json',
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Task Management</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <h3 class="card-title">Search Task</h3>
                        </div>
                        <!--begin::Form-->
                        <form:form class="form" id="taskviewform" name="tasksearch" action="addTask" theme="simple"
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            <input id="searchCode" type="text"
                                                   ...
                                                   maxlength="16"
                                                   class="form-control form-control" placeholder="Task Code">
                                        </div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-1 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Task Management
                            <span class="d-block text-muted pt-2 font-size-sm">Task list</span></h3>
                    </div>
            ...
            <!--end::Card-->
            <!--begin::Card-->
            <c:if test="${task.vdualauth}">
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Tasks to be confirmed</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin: Datatable-->
...
<jsp:include page="task-mgt-add.jsp"/>
<jsp:include page="task-mgt-update.jsp"/>
