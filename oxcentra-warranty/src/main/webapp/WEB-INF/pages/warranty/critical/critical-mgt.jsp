...
<head>
    ...
    <script type="text/javascript">
        ...
        function downloadCSVReport() {
            form = document.getElementById('criticalform');
            form.action = 'csvCritical.htm';
            form.submit();
        }
        ...
        function loadDataTable() {
            ...
            oTable = $('#table').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listCritical.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    ...
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listCritical.json",
        ...
        function editClaimInit(id) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/getCritical.json",
                data: {
                    id: id
                },
                dataType: "json",
        ...
        function deleteCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/deleteCritical.json',
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-1 pb-0">
                    <form:form class="form" id="criticalform" name="criticalsearch" action="Critical" theme="simple"
...
<jsp:include page="critical-mgt-view.jsp"/>
