    ...
    <script type="text/javascript">
        ...
        function loadDataTable() {
            ...
            oTable = $('#table').dataTable({
                bServerSide: true,
                sAjaxSource: "${pageContext.servletContext.contextPath}/listDealership.json",
                fnServerData: function (sSource, aoData, fnCallback) {
                    aoData.push(
                        {'name': 'csrf_token', 'value': token},
                        {'name': 'header', 'value': header},
                        {'name': 'dealershipCode', 'value': $('#dealershipCode').val()},
                        {'name': 'status', 'value': $('#status').val()},
                    );
                    $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: "${pageContext.request.contextPath}/listDealership.json",
                ...
                columnDefs: [
                    {
                        title: "Dealership Code",
                        targets: 0,
                        mDataProp: "dealershipCode",
                        defaultContent: "--"
                    },
                    {
                        title: "Status",
                    ...
                    },
                    {
                        title: "Name",
                        targets: 2,
                        mDataProp: "dealershipName",
                        defaultContent: "--"
                    },
                    {
                        title: "Phone",
                        targets: 3,
                        mDataProp: "dealershipPhone",
                        defaultContent: "--"
                    },
                    {
                        title: "Email",
                        targets: 4,
                        mDataProp: "dealershipEmail",
                        defaultContent: "--"
                    },
                    {
                        title: "Address",
                        targets: 5,
                        mDataProp: "dealershipAddress",
                        defaultContent: "--"
                    },
                    {
                    ...
                    {
                        visible: ${dealership.vupdate},
                        title: "Update",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="editBtn" class="btn btn-default btn-sm"  onclick="editTaskInit(\'' + full.dealershipCode + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-edit.svg" alt=""></button>';
                        },
                        targets: 8,
                        defaultContent: "--"
                    },
                    {
                        visible: ${dealership.vdelete},
                        title: "Delete",
                        sortable: false,
                        className: "dt-center",
                        mRender: function (data, type, full) {
                            return '<button id="deleteBtn" class="btn btn-default btn-sm"  onclick="deleteTaskInit(\'' + full.dealershipCode + '\')"><img src="${pageContext.request.contextPath}/resources/images/action-delete.svg" alt=""></button>';
                        },
                        targets: 9,
                        defaultContent: "--"
                    }
        ...
        function editTaskInit(dealershipCode) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#modalUpdateDealership').modal('toggle');
                    $('#modalUpdateDealership').modal('show');
                },
                error: function (data) {
                    window.location = "${pageContext.request.contextPath}/logout.htm";
                }
        ...
        function openAddModal() {
            $('#modalAddDealership').modal('toggle');
            $('#modalAddDealership').modal('show');
        }

        function deleteCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/deleteDealership.json',
                data: {dealershipCode: $('#deleteCodeCommon').val()},
        ...
        function confirmCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/confirmDealership.json',
        ...
        function rejectCommon() {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/rejectDealership.json',
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Dealership Management</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-1 pb-0">
                    <div class="card-title">
                        <div class="row">
                            <div class="col-lg-9">
                                <input id="dealershipCode" name="dealershipCode" type="text"  maxlength="50" class="form-control" >
                            </div>
                            <div class="col-lg-3">
            ...
            <!--end::Card-->
            <!--begin::Card-->
            <c:if test="${dealership.vdualauth}">
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Dealerships to be confirmed</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin: Datatable-->
...
<jsp:include page="dealership-mgt-add.jsp"/>
<jsp:include page="dealership-mgt-update.jsp"/>
